...
<AccordionGroup>
  <Accordion title="'genie' command not found" icon="terminal">
    ...
    **Alternative: Use npx (no installation needed):**
    ...
    npx @joshuapowell/genie-cli status
    ```
...
<AccordionGroup>
  ...
  <Accordion title="Init fails to download required files" icon="download">
    ...
    **Solution:**
    ...
    curl https://registry.npmjs.org/@joshuapowell/genie-cli
...
<AccordionGroup>
  <Accordion title="Update fails with version conflict" icon="code-compare">
    ...
    **Solution:**
    ...
    # Check current version
    genie --version
    npm list -g @joshuapowell/genie-cli
    ...
    npm uninstall -g @joshuapowell/genie-cli
    npm install -g @joshuapowell/genie-cli@latest
  ...
  <Accordion title="Cannot rollback to previous version" icon="clock-rotate-left">
    ...
    **Solution:**
    ...
    npm view @joshuapowell/genie-cli versions

    # Install specific version
    npm install -g @joshuapowell/genie-cli@1.2.3

    # If version unpublished, try nearby version
    npm install -g @joshuapowell/genie-cli@1.2.2
...
4. **Report issues:**
   - GitHub: [joshuapowell/genie/issues](https://github.com/joshuapowell/genie/issues)
