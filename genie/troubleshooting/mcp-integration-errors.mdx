...
1. **Collect diagnostic info:**
   ...
   npm list -g @joshuapowell/genie-cli > version.txt
   ```
...
3. **Get help:**
   - GitHub Issues: [joshuapowell/genie/issues](https://github.com/joshuapowell/genie/issues)
   - Discord: Join community server
   - Documentation: Check IDE-specific MCP docs
   - Stack Overflow: Tag with `genie-cli` and `mcp`
