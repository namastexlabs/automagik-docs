...
<AccordionGroup>
  ...
  <Accordion title="Can I contribute to Master Genie?" icon="code-branch">
    ...
    **4. Bug reports and feature requests:**
    - [GitHub Issues](https://github.com/namastexlabs/automagik-genie/issues)
  ...
  <Accordion title="How do version updates work?" icon="arrow-up-from-bracket">
    ...
    **Stay informed:**
    - GitHub releases: [github.com/namastexlabs/automagik-genie/releases](https://github.com/namastexlabs/automagik-genie/releases)
...
<AccordionGroup>
  ...
  <Accordion title="Forge connection failed" icon="cloud-slash">
    ...
    **3. Network issues:**
    ...
    # Check if behind proxy (if using remote Forge)
    genie config set FORGE_PROXY "http://proxy.company.com:8080"

    # Ensure Forge is running locally
    forge status
    ```

    **4. Forge outage:**
    - Check Forge status locally with `forge status`
    - Ensure Forge is running on localhost:8887
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub Issues" icon="github" href="https://github.com/namastexlabs/automagik-genie/issues">
...
5. **Community support**: Join Discord for help
