...
<AccordionGroup>
  <Accordion title="Installation fails with 'npm ERR! code EACCES'" icon="triangle-exclamation">
    **Symptoms:**
    - Permission denied errors during `npm install -g automagik-genie`
  ...
  <Accordion title="Installation hangs at 'Downloading binaries...'" icon="spinner">
    ...
    **Solution:**
    ...
    # Increase timeout
    npm install -g automagik-genie --fetch-timeout=60000
...
<AccordionGroup>
  <Accordion title="Cannot connect to Forge" icon="link-slash">
    ...
    **Solution:**
    ...
    genie config set FORGE_URL http://localhost:8887
...
3. **Update Genie**: `npm update -g automagik-genie`
4. **Search GitHub Issues**: [github.com/namastexlabs/automagik-genie/issues](https://github.com/namastexlabs/automagik-genie/issues)
